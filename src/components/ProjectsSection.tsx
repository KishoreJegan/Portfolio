...
const PROJECTS: ProjectItem[] = [
  {
    ...
    demoUrl: '#',
    githubUrl: 'https://github.com/KishoreJegan/NIFTY-OPTIONCHAIN-AI'
  },
  {
    id: 'python-ai-agent',
    title: 'Python Smart AI Agent',
    ...
    demoUrl: '#',
    githubUrl: 'https://github.com/KishoreJegan/Python-based-AI-Agent'
  }
];
...
export const ProjectsSection: React.FC = () => {
  ...
  const titleY = useTransform(scrollYProgress, [0, 0.04, 0.94, 1], [-30, 0, 0, 0]);
  const titleOpacity = useTransform(scrollYProgress, [0, 0.02, 0.94, 0.99], [0, 1, 1, 0]);

  // FIRST TAB: Pops in split-second (starts close to center, no long orbit travel)
  ...
  const rightSlabFilter = useTransform(
    scrollYProgress,
    [0, 0.04, 0.30, 0.36],
    ['blur(8px)', 'blur(0px)', 'blur(0px)', 'blur(24px)']
  );
  ...
  // SHORT GAP: 0.36 → 0.42 (empty screen between tabs)

  // SECOND TAB: Follows right after with fast orbit from LEFT
  const leftSlabX = useTransform(
    scrollYProgress,
    [0, 0.42, 0.55, 0.78, 0.88],
    ['-20vw', '-20vw', '0vw', '0vw', '35vw']
  );
  ...
  const leftSlabOpacity = useTransform(
    scrollYProgress,
    [0, 0.42, 0.46, 0.55, 0.78, 0.88],
    [0, 0, 0.7, 1, 1, 0]
  );
  const leftSlabScale = useTransform(
    scrollYProgress,
    [0, 0.42, 0.55, 0.78, 0.88],
    [0.85, 0.85, 1.0, 1.0, 0.72]
  );
  const leftSlabFilter = useTransform(
    scrollYProgress,
    [0, 0.42, 0.55, 0.78, 0.88],
    ['blur(8px)', 'blur(8px)', 'blur(0px)', 'blur(0px)', 'blur(24px)']
  );
  ...
  return (
    <div ref={containerRef} id="projects" className="relative h-[160vh] text-white">
