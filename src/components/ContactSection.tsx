...
import { Mail, Send, Linkedin, Github, Download, CheckCircle2, User, FileText } from 'lucide-react';
...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative w-full min-h-screen text-white pt-24 pb-28 px-6 sm:px-12 md:px-16 overflow-hidden border-t border-white/10 flex flex-col items-center justify-center">
      ...
      <div className="max-w-3xl mx-auto relative z-10 flex flex-col items-center text-center w-full">
        ...
        >
          ...
          {isSubmitted ? (
            ...
            >
              <div className="p-4 rounded-full bg-white/10 border border-white/20 text-white mb-4 shadow-[0_0_20px_rgba(255,255,255,0.25)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Name Field */}
                <div>
                  <label className="block text-xs font-mono uppercase tracking-wider text-white font-semibold mb-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border border-white/25 focus:border-white/80 focus:bg-white/[0.15] text-white text-xs sm:text-sm placeholder-white/60 outline-none transition-all font-medium"
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-xs font-mono uppercase tracking-wider text-white font-semibold mb-2">
                    Your Email <span className="text-white/60">*</span>
                  </label>
                  <div className="relative">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-xl bg-black/40 border border-white/25 focus:border-white/80 focus:bg-white/[0.15] text-white text-xs sm:text-sm placeholder-white/60 outline-none transition-all resize-none font-medium"
                />
              </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            {/* LinkedIn Profile */}
            <a
              href="https://linkedin.com/in/kishorejegan"
              target="_blank"
            ...
            {/* GitHub Profile */}
            <a
              href="https://github.com/KishoreJegan"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-3 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/20 hover:border-white/40 text-white font-medium text-xs sm:text-sm backdrop-blur-2xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg group"
            >
            ...
            {/* LeetCode Profile */}
            <a
              href="https://leetcode.com/u/Kishore_Jegan/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-5 py-3 rounded-2xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/20 hover:border-white/40 text-white font-medium text-xs sm:text-sm backdrop-blur-2xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg group"
            >
          ...
          {/* Bottom Row (Beneath): View Resume in Glassmorphism */}
          <a
            href="/Kishore_J_Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
